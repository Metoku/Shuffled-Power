...
public enum BattleStateS1M7 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS1M7 : MonoBehaviour
{
    //player anim bool
    ...
    [Header("Subtraction Answers & Sets")] 
    public int answer21;
    public int answer22;
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateS1M7.PLAYERTURN;
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateS1M7.ENEMYTURN;
            attackPanel.SetActive(false);
    ...
    private IEnumerator EnemyTurn()
    {
        ...
        VoiceAudioSource.Play();
        yield return new WaitForSeconds(2f);
        int enemyDmg = Random.Range(7, 10);
    ...
    private IEnumerator randomEquation()
    {
        ...
        if (randomOperator == 1)
        {
            ...
            battleEventText.text = "The expression to be solved is addition";
            yield return new WaitForSeconds(1f);
        }
        else if (randomOperator == 2)
        {
            battleEventText.text = "The expression to be solved is subtraction";
            yield return new WaitForSeconds(1f);
        }
        ...
        {
            UniqueRandomIntSubtraction(1, 21);
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateS1M7.WON)
        {
            ...
            //loadController.LoadLevel(1);
            ProgressController.progressInstance.B7Win = true;
        ...
        else if (state == BattleStateS1M7.LOST)
        {
    ...
    public int UniqueRandomIntAddition(int min, int max)
    {
    ...
    public int UniqueRandomIntSubtraction(int min, int max)
    {
        int val = Random.Range(min, max);
        while(randomizer == val)
        {
