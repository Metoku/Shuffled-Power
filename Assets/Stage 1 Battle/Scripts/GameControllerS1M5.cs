...
public enum BattleStateS1M5 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS1M5 : MonoBehaviour
{
    //player anim bool
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateS1M5.PLAYERTURN;
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateS1M5.ENEMYTURN;
            equationPanel.SetActive(false);
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateS1M5.WON)
        {
            ...
            //loadController.LoadLevel(1);
            ProgressController.progressInstance.B5Win = true;
        ...
        else if (state == BattleStateS1M5.LOST)
        {
