...
public enum BattleStateS1M3 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS1M3 : MonoBehaviour
{
    //player anim bool
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateS1M3.PLAYERTURN;
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateS1M3.ENEMYTURN;
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateS1M3.WON)
        {
            ...
            //loadController.LoadLevel(1);
            ProgressController.progressInstance.B3Win = true;
        ...
        else if (state == BattleStateS1M3.LOST)
        {
