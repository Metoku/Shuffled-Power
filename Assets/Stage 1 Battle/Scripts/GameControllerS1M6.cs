...
public enum BattleStateS1M6 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS1M6 : MonoBehaviour
{
    //player anim bool
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateS1M6.PLAYERTURN;
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateS1M6.ENEMYTURN;
            attackPanel.SetActive(false);
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateS1M6.WON)
        {
            ...
            //loadController.LoadLevel(1);
            ProgressController.progressInstance.B6Win = true;
        ...
        else if (state == BattleStateS1M6.LOST)
        {
