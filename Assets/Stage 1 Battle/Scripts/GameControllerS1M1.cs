...
public enum BattleStateM1S1 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS1M1 : MonoBehaviour
{
    //player anim bool
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateM1S1.PLAYERTURN;
    ...
    {
        healing = StartCoroutine(BtnHeal());
    }
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateM1S1.ENEMYTURN;
            equationPanel.SetActive(false);
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateM1S1.WON)
        {
            ...
            //loadController.LoadLevel(1);
            ProgressController.progressInstance.B1Win = true;
        ...
        else if (state == BattleStateM1S1.LOST)
        {
