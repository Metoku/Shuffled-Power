...
public enum BattleStatePractice { START, PLAYERTURN, ENEMYTURN, WON, LOST }
...
public class GameControllerPractice : MonoBehaviour
{
    ...
    public BattleStatePractice state;
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStatePractice.PLAYERTURN;
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStatePractice.ENEMYTURN;
            attackPanel.SetActive(false);
    ...
    private IEnumerator EnemyTurn()
    {
        ...
        if (playerHP <= 0)
        {
            state = BattleStatePractice.LOST;
    ...
    {
        if (state == BattleStatePractice.WON)
        {
            BattleEvents.SetActive(false);
            attackPanel.SetActive(false);
            battleUI.SetActive(false);
        ...
        else if (state == BattleStatePractice.LOST)
        {
