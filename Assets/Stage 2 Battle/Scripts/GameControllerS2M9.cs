...
public enum BattleStateS2M9 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS2M9 : MonoBehaviour
{
    //player anim bool
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateS2M9.PLAYERTURN;
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateS2M9.ENEMYTURN;
            attackPanel.SetActive(false);
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateS2M9.WON)
        {
            ...
            ProgressController.progressInstance.B9Win = true;
        ...
        else if (state == BattleStateS2M9.LOST)
        {
