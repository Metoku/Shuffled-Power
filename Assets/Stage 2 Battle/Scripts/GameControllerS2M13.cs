...
public enum BattleStateS2M13 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS2M13 : MonoBehaviour
{
    //player anim bool
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateS2M13.PLAYERTURN;
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateS2M13.ENEMYTURN;
            attackPanel.SetActive(false);
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateS2M13.WON)
        {
            ...
            ProgressController.progressInstance.B13Win = true;
        ...
        else if (state == BattleStateS2M13.LOST)
        {
