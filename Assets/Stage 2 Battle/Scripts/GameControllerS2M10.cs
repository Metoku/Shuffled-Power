...
public enum BattleStateS2M10 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS2M10 : MonoBehaviour
{
    //player anim bool
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateS2M10.PLAYERTURN;
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateS2M10.ENEMYTURN;
            attackPanel.SetActive(false);
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateS2M10.WON)
        {
            ...
            ProgressController.progressInstance.B10Win = true;
        ...
        else if (state == BattleStateS2M10.LOST)
        {
