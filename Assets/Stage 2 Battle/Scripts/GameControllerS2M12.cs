...
public enum BattleStateS2M12 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS2M12 : MonoBehaviour
{
    //player anim bool
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateS2M12.PLAYERTURN;
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateS2M12.ENEMYTURN;
            attackPanel.SetActive(false);
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateS2M12.WON)
        {
            ...
            ProgressController.progressInstance.B12Win = true;
        ...
        else if (state == BattleStateS2M12.LOST)
        {
