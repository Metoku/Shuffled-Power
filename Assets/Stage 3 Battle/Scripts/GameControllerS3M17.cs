...
public enum BattleStateS3M17 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS3M17 : MonoBehaviour
{
    //player anim bool
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateS3M17.PLAYERTURN;
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateS3M17.ENEMYTURN;
            attackPanel.SetActive(false);
    ...
    private IEnumerator EnemyTurn()
    {
        ...
        yield return new WaitForSeconds(2f);
        int enemyDmg = Random.Range(15, 18);
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateS3M17.WON)
        {
            ...
            ProgressController.progressInstance.B17Win = true;
        ...
        else if (state == BattleStateS3M17.LOST)
        {
