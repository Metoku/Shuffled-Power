...
public enum BattleStateS3M16 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS3M16 : MonoBehaviour
{
    //player anim bool
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateS3M16.PLAYERTURN;
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateS3M16.ENEMYTURN;
            attackPanel.SetActive(false);
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateS3M16.WON)
        {
            ...
            ProgressController.progressInstance.B16Win = true;
        ...
        else if (state == BattleStateS3M16.LOST)
        {
