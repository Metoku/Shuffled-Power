...
public enum BattleStateS3M18 { START, PLAYERTURN, ENEMYTURN, WON, LOST }

public class GameControllerS3M18 : MonoBehaviour
{
    //player anim bool
    ...
    [Header("Controller")] public LoadController loadController;
    ...
    [SerializeField] private GameObject mathSet31;
    [SerializeField] private GameObject mathSet32;
    [SerializeField] private GameObject mathSet33;
    [SerializeField] private GameObject mathSet34;
    [SerializeField] private GameObject mathSet35;
    [SerializeField] private GameObject mathSet36;
    [SerializeField] private GameObject mathSet37;
    [SerializeField] private GameObject mathSet38;
    [SerializeField] private GameObject mathSet39;
    [SerializeField] private GameObject mathSet40;
    ...
    void Start()
    {
        ...
        //shuffleEquations();
        state = BattleStateS3M18.PLAYERTURN;
    ...
    public void BtnSkip()
    {
        ...
        else if (randomizer == 31)
        {
            mathSet31.SetActive(false);
        }
        else if (randomizer == 32)
        {
            mathSet32.SetActive(false);
        }
        else if (randomizer == 33)
        {
            mathSet33.SetActive(false);
        }
        else if (randomizer == 34)
        {
            mathSet34.SetActive(false);
        }
        else if (randomizer == 35)
        {
            mathSet35.SetActive(false);
        }
        else if (randomizer == 36)
        {
            mathSet36.SetActive(false);
        }
        else if (randomizer == 37)
        {
            mathSet37.SetActive(false);
        }
        else if (randomizer == 38)
        {
            mathSet38.SetActive(false);
        }
        else if (randomizer == 39)
        {
            mathSet39.SetActive(false);
        }
        else if (randomizer == 40)
        {
            mathSet40.SetActive(false);
        }
    ...
    public IEnumerator ChangeTurn()
    {
        ...
        if (!playerTurn)
        {
            ...
            state = BattleStateS3M18.ENEMYTURN;
            attackPanel.SetActive(false);
    ...
    private IEnumerator EnemyTurn()
    {
        ...
        VoiceAudioSource.Play();
        yield return new WaitForSeconds(2f);
        int enemyDmg = Random.Range(16, 19);
    ...
    private IEnumerator randomEquation()
    {
        ...
        else if (randomizer == 31)
        {
            /* GameObject equation = Instantiate(mathSet3, mathSet3.transform.position, mathSet3.transform.rotation) as GameObject;
             equation.transform.SetParent(GameObject.Find("EquationParent").transform, false);*/
            mathSet31.SetActive(true);
        }
        else if (randomizer == 32)
        {
            /* GameObject equation = Instantiate(mathSet3, mathSet3.transform.position, mathSet3.transform.rotation) as GameObject;
             equation.transform.SetParent(GameObject.Find("EquationParent").transform, false);*/
            mathSet32.SetActive(true);
        }
        else if (randomizer == 33)
        {
            /* GameObject equation = Instantiate(mathSet3, mathSet3.transform.position, mathSet3.transform.rotation) as GameObject;
             equation.transform.SetParent(GameObject.Find("EquationParent").transform, false);*/
            mathSet33.SetActive(true);
        ...
        else if (randomizer == 34)
        {
            /* GameObject equation = Instantiate(mathSet3, mathSet3.transform.position, mathSet3.transform.rotation) as GameObject;
             equation.transform.SetParent(GameObject.Find("EquationParent").transform, false);*/
            mathSet34.SetActive(true);
        }
        else if (randomizer == 35)
        {
            /* GameObject equation = Instantiate(mathSet3, mathSet3.transform.position, mathSet3.transform.rotation) as GameObject;
             equation.transform.SetParent(GameObject.Find("EquationParent").transform, false);*/
            mathSet35.SetActive(true);
        }
        else if (randomizer == 36)
        {
            /* GameObject equation = Instantiate(mathSet3, mathSet3.transform.position, mathSet3.transform.rotation) as GameObject;
             equation.transform.SetParent(GameObject.Find("EquationParent").transform, false);*/
            mathSet36.SetActive(true);
        }
        else if (randomizer == 37)
        {
            /* GameObject equation = Instantiate(mathSet3, mathSet3.transform.position, mathSet3.transform.rotation) as GameObject;
             equation.transform.SetParent(GameObject.Find("EquationParent").transform, false);*/
            mathSet37.SetActive(true);
        }
        else if (randomizer == 38)
        {
            /* GameObject equation = Instantiate(mathSet3, mathSet3.transform.position, mathSet3.transform.rotation) as GameObject;
             equation.transform.SetParent(GameObject.Find("EquationParent").transform, false);*/
            mathSet38.SetActive(true);
        }
        else if (randomizer == 39)
        {
            /* GameObject equation = Instantiate(mathSet3, mathSet3.transform.position, mathSet3.transform.rotation) as GameObject;
             equation.transform.SetParent(GameObject.Find("EquationParent").transform, false);*/
            mathSet39.SetActive(true);
        }
        else if (randomizer == 40)
        {
            /* GameObject equation = Instantiate(mathSet3, mathSet3.transform.position, mathSet3.transform.rotation) as GameObject;
             equation.transform.SetParent(GameObject.Find("EquationParent").transform, false);*/
            mathSet40.SetActive(true);
        }
    ...
    IEnumerator EndBattle()
    {
        if (state == BattleStateS3M18.WON)
        {
            ...
            loadController.LoadLevel(25);
            //loadController.LoadLevel(8);
            ProgressController.progressInstance.B18Win = true;
        ...
        else if (state == BattleStateS3M18.LOST)
        {
